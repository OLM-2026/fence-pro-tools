      ...
      <footer className="bg-primary text-primary-foreground border-t mt-16">
        ...
        <div className="container mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-2">
            ...
            <p className="text-primary-foreground/70 max-w-md text-sm leading-relaxed">
              The definitive independent resource for fence company owners who want to save time, make
              more money, and run a smarter fence business. Built for the trade, not just any small
              business.
            </p>
          </div>

          <div>
            <h4 className="font-bold mb-4 text-[#f5a623] uppercase tracking-wider text-xs">
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li>
                <Link href={categoryUrl("crm")} className="hover:text-white transition-colors">
                  CRM Software
                </Link>
              </li>
              <li>
        ...
        <div className="container mx-auto px-4 pb-8 border-t border-primary-foreground/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-sm text-primary-foreground/40">
          ...
          <span className="text-xs">
            Independent directory. Not affiliated with any software company.
          </span>
        </div>
      </footer>
